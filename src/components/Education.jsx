...
const TimelineItem = ({ title, subtitle, date, description }) => (
    <div className="relative pl-4 border-l-2 border-blue-600 pb-4">
        <div className="absolute -left-[9px] top-5 w-3.5 h-3.5 bg-blue-600 rounded-full shadow-lg ring-4 dark:ring-gray-200"></div>
        <div className="bg-white/20 backdrop-blur-xl rounded-lg shadow-md hover:shadow-xl transition-all duration-300 p-4 hover:scale-[1.01] hover:shadow-indigo-500/30">
            ...
            <p className="text-sm mb-1 font-semibold">{subtitle}</p>
